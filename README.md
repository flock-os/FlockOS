...
| File | Lines | Description |
|------|------:|-------------|
| `the_good_shepherd.html` | 2,380 | **Main app shell** — primary authenticated UI |
| `the_great_commission.html` | 2,285 | Admin Hub — deployment, permissions, audit, config |
| `the_pentecost.html` | 2,057 | Comprehensive as-built & deployment guide |
| `bezalel.html` | 1,794 | Bezalel Matrix — interactive architecture map |
| `quarterly_worship.html` | 1,668 | Quarterly Worship planner |
| `fishing-for-men.html` | 824 | Value proposition / evangelism pitch |
| `index.html` | 800 | App redirect shell |
| `the_wall.html` | 628 | Login page |
| `the_gift_drift.html` | 527 | Spiritual Gifts — 4-phase curriculum |
| `the_anatomy_of_worship.html` | 493 | Teaching — Anatomy of Worship |
| `the_call_to_forgive.html` | 480 | Teaching — The Call to Forgive |
| `the_generations.html` | 460 | Teaching — Generational Dynamics |
...
| File | Lines | JS Object | Role |
|------|------:|-----------|------|
| `the_tabernacle.js` | 21,105 | `Modules` | Core renderer — 48+ module UIs, Themes, Interface Studio |
| `fine_linen.js` | 6,265 | `Adornment` | CSS theme system — 13 themes + Interface Studio styles |
| `the_upper_room.js` | 4,921 | `UpperRoom` | Firebase Firestore comms — DMs, chat rooms, channels, notifications |
| `the_life.js` | 3,896 | `TheLife` | My Flock Portal — pastoral command hub |
| `the_way.js` | 3,429 | `TheWay` | Learning Hub — 16-tab education dashboard |
| `the_seasons.js` | 2,503 | `TheSeason` | Calendar, Tasks & Check-In Hub |
| `the_shofar.js` | 2,102 | `musicStandAppState` | Song library, chord charts, Music Stand, PDF export |
| `the_true_vine.js` | 1,410 | `TheVine` | Centralized API client — 4 branches (John/Luke/Matthew/Mark) |
| `the_commission.js` | 1,333 | `Blueprint` | Deployment automation blueprint |
| `the_shepherd.js` | 1,327 | `TheShepherd` | People Engine — member search/profile/3-step save |
| `the_harvest.js` | 951 | `TheHarvest` | Ministry Hub — events, sermons, service plans, songs |
| `the_cornerstone.js` | 807 | `Temple` | Architecture registry (runtime-queryable) |
| `the_wellspring.js` | 752 | `TheWellspring` | Local data layer — IndexedDB offline mode |
| `the_truth.js` | 670 | `TheTruth` | Content Editor — full CRUD for all public content tabs |
| `firm_foundation.js` | 581 | `Nehemiah` | Auth guard — login, logout, RBAC, route guard |
| `the_well.js` | 579 | `TheWell` | Google Drive sync for offline churches |
| `the_trumpet.js` | 486 | `Trumpet` | Phone, share, notifications, QR, geolocation |
| `the_scrolls.js` | 316 | `TheScrolls` | Interaction Ledger — 30+ pastoral touchpoint types |
| `the_fold.js` | 297 | `TheFold` | Groups & Attendance |
| `the_living_water.js` | 232 | _(service worker)_ | Service worker source |
| `the_pagans.js` | 160 | — | Parked / dormant code |

**Total: ~54,000 lines of JavaScript across 21 files**

...
#
# Usage:
#   bash Covenant/Bezalel/Scripts/B-Export_Standalone.sh <ShortName>
#   bash Covenant/Bezalel/Scripts/B-Export_Standalone.sh TBC
#   bash Covenant/Bezalel/Scripts/B-Export_Standalone.sh TheForest --dry-run
# ======================================================================
set -euo pipefail
...
echo "[2/7] Copying Covenant/Bezalel/ (build scripts)…"
rsync "${RSYNC_FLAGS[@]}" "${COMMON_EXCLUDES[@]}" \
  "$COVENANT_ROOT/Bezalel/" "$EXPORT_DEST/Covenant/Bezalel/"

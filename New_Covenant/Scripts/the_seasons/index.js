/* ══════════════════════════════════════════════════════════════════════════════
  ...
  export function todoFilterBy(key) {
    _todoFilter = key;
  ...
  export function calEventDetail(id, title, date) {
  ...
  export function calNewPersonal() {
    var prefill = _calFmt(_calDate);
  ...
  export async function calEditPersonal(eventId) {
  ...
  export async function calDeletePersonal(eventId) {
    var overlay = document.getElementById('fl-modal');
    if (overlay) overlay.remove();
  ...
  export async function calEditEvent(eventId) {
    var overlay = document.getElementById('fl-modal');
    if (overlay) overlay.remove();
  ...
  export async function calArchiveEvent(eventId) {
    var overlay = document.getElementById('fl-modal');
    if (overlay) overlay.remove();
  ...
  export async function calCancelEvent(eventId) {
    var overlay = document.getElementById('fl-modal');
    if (overlay) overlay.remove();
  ...
  export async function viewEventRsvps(eventId) {
    try {
      var res = _isFB()
  ...
  export function calDownloadICS() {
  ...
  export function _calCopyUrl(btnId) {
  ...
  export async function calRegenToken() {
  ...
  export function calSwitchMode(mode) {
    _calMode = mode;
  ...
  export async function calDelegation() {
    var myDelegations = [];
    var delegatedToMe = [];
  ...
  export async function _calGrantDelegation() {
  ...
  export async function _calRevokeDelegation(id) {
  ...
  export async function calRefresh() {
    _calIcalCache = {};
    await _calLoad(true);
    _calRender(document.getElementById('cal-body'));
  }
  ...
  export function _calSettingsSave() {
    var obj = {};
  ...
  export function todoRefresh() { _reload('calendar'); }
  ...
  export function openCheckinSession() {
  ...
  export function renderCalendar(el, sess) {
    _session = sess || {};
    var s = _calSettings();

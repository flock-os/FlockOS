/* ══════════════════════════════════════════════════════════════════════════════
  ...
  export async function _loadPerms(email) {
  ...
  export async function _loadVolunteers(email) {
  ...
  export function _loadHistory(email) {
  ...
  // ── Approve / Deny ──────────────────────────────────────────────────────
  export async function _approve(email) {
  ...
  export async function _deny(email) {
  ...
  export async function openProfile(email) {
  ...
  export async function _createMember(email) {
    var p = _ppData[(email || '').toLowerCase()] || {};
    var u = p.user || {};
  ...
  export async function _deleteMember(memberId, email) {
  ...
  export async function _createCard(email) {
    var p = _ppData[(email || '').toLowerCase()] || {};
    var u = p.user || {};
    try {
  ...
  export function _selectPreset(templateKey) {
    var templates = window._shepPermTemplates || {};
  ...
  export function _onAdvChkChange() {
    _syncAdvCritConfirm();
  }
  ...
  export async function _savePerms(targetEmail) {
    var canEditPerms = false;
    try {
      if (typeof Nehemiah !== 'undefined' && (Nehemiah.can('users.permissions') || Nehemiah.can('users.edit'))) {
        canEditPerms = true;
  ...
  export async function _deleteUser(email) {
  ...
  export async function _resetPasscode(email) {
  ...
  export async function _createUserAccount(email) {
    var p = _ppData[(email || '').toLowerCase()] || {};
    var m = p.member || {};

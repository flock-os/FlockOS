...
let _liveCasesMap   = {};
let _membersCache   = null;  // { id, label, name }[]
...
// Build <option> list for a member select, with optional pre-selected name.
function _memberOptions(selectedName) {
  ...
  // If selectedName not in list (free-text from old record), add it

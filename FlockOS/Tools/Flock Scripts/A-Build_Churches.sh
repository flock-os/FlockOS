...
MASTER_CODE="$REPO_ROOT/FlockOS/Tools/Flock Docs/L-Master Code.md"
...
out += '// Source: FlockOS/Tools/Flock Docs/L-Master Code.md\n'
out += '// Lines: ' + str(lines) + '\n'
...
FIRESTORESYNC_MD="$REPO_ROOT/FlockOS/Tools/Flock Docs/M-Master FirestoreSync.md"
...
lines = len(content.splitlines())
out  = '// AUTO-GENERATED by A-Build_Churches.sh — do not edit manually.\n'
out += '// Source: FlockOS/Tools/Flock Docs/M-Master FirestoreSync.md\n'
out += '// Lines: ' + str(lines) + '\n'
...
SYNCHANDLER_MD="$REPO_ROOT/FlockOS/Tools/Flock Docs/N-Master SyncHandler.md"
...
lines = len(content.splitlines())
out  = '// AUTO-GENERATED by A-Build_Churches.sh — do not edit manually.\n'
out += '// Source: FlockOS/Tools/Flock Docs/N-Master SyncHandler.md\n'
out += '// Lines: ' + str(lines) + '\n'
...
CAMELCASE_MD="$REPO_ROOT/FlockOS/Tools/Flock Docs/O-Master CamelCase.md"
...
lines = len(content.splitlines())
out  = '// AUTO-GENERATED by A-Build_Churches.sh — do not edit manually.\n'
out += '// Source: FlockOS/Tools/Flock Docs/O-Master CamelCase.md\n'
out += '// Lines: ' + str(lines) + '\n'

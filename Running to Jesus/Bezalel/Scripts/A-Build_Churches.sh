...
FIRESTORESYNC_MD="$WORKSPACE_ROOT/Architechtural Docs/New Covenant/Architecture/C-Master FirestoreSync.md"
...
lines = len(content.splitlines())
out  = '// AUTO-GENERATED by A-Build_Churches.sh — do not edit manually.\n'
out += '// Source: Architechtural Docs/New Covenant/Architecture/C-Master FirestoreSync.md\n'
out += '// Lines: ' + str(lines) + '\n'
...
SYNCHANDLER_MD="$WORKSPACE_ROOT/Architechtural Docs/New Covenant/Architecture/D-Master SyncHandler.md"
...
lines = len(content.splitlines())
out  = '// AUTO-GENERATED by A-Build_Churches.sh — do not edit manually.\n'
out += '// Source: Architechtural Docs/New Covenant/Architecture/D-Master SyncHandler.md\n'
out += '// Lines: ' + str(lines) + '\n'
...
CAMELCASE_MD="$WORKSPACE_ROOT/Architechtural Docs/New Covenant/Architecture/E-Master CamelCase.md"
...
lines = len(content.splitlines())
out  = '// AUTO-GENERATED by A-Build_Churches.sh — do not edit manually.\n'
out += '// Source: Architechtural Docs/New Covenant/Architecture/E-Master CamelCase.md\n'
out += '// Lines: ' + str(lines) + '\n'
